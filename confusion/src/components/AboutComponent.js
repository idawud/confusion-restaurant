	...
	return (
		<Media className="container">
			...
			<Media right body className="container">
				...
				{leader.designation}
				<Media className="leader-description">{leader.description}</Media>
			</Media>
		</Media>
	);
}
			...
			<div className="row row-content">
				<div className="col-12 col-md-6">
					...
					<p>
						...
						excellence in Ghana and the West African region. With its unique brand of world fusion cuisine
						that can be found nowhere else, it enjoys patronage from the A-list clientele in Ghana.
					...
					<p>
						...
						started by our CEO, Mr. Peter Smith, that featured for the first time the world's best cuisines
						in a pan.
					</p>
				</div>
					...
					<Card>
						...
						<CardBody>
							<dl className="row p-1">
								...
								<dd className="col-6">GH Fine Foods Inc.</dd>
